...
GROUP BY purchase_year, purchase_month, purchase_day, order_line_id, refunded_order, Deal_id
         ...
         , refunded_Day, Manager, Deal_Owner, Customer_comment, refunded_source"
...
echo "Table refresh status of refund table and cancellation tablein BI dataset:$v_table_status`date`" | mail -s "$v_table_status" rashmi.mishra@nearbuy.com ashish.singh@nearbuy.com  ##sairanganath.v@nearbuy.com alka.gupta@nearbuy.com
