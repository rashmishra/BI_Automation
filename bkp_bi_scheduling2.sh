...
echo "Table refresh status of refund table, cancellation table and redemption table in BI dataset:$v_table_status`date`" | mail -s "$v_table_status" rashmi.mishra@nearbuy.com akhil.dhingra@nearbuy.com alka.gupta@nearbuy.com
