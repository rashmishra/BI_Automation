...
while read line
do
cd /home/ubuntu/BI/scripts/CM_Reports/refunds
./refunds.sh $line 10
done < /home/ubuntu/BI/scripts/CM_Reports/refunds/CMList.csv
...
Thanks in advance" | mutt -s "Updated sales data till $(date)" -c rashmi.mishra@nearbuy.com akhil.dhingra@nearbuy.com ankur.sarawagi@nearbuy.com  alka.gupta@nearbuy.com anish.sinha@nearbuy.com -y
