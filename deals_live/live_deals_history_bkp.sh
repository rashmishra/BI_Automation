...
echo "Live deals history status:$v_table_status`date`:Please follow the link for CSV: https://drive.google.com/drive/folders/0Bw76R706sm29X3UwOUZVX2JRS1k" | mail -s "$v_table_status" rashmi.mishra@nearbuy.com akhil.dhingra@nearbuy.com alka.gupta@nearbuy.com
